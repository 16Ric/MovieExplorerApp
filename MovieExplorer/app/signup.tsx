...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    // Prevent signup if there are validation errors
    ...
    try {
      ...
      switch (err.code) {
        ...
        case "auth/weak-password":
          setErrors((prev) => ({
            ...prev,
            password: "Password is too weak. Use at least 8 characters with letters, numbers, and symbols.",
          }));
          break;
        default:
...
const styles = StyleSheet.create({
  ...
  button: { paddingVertical: 15, borderRadius: 8, marginVertical: 10, alignItems: "center" },
